...
Этот скрипт автоматизирует полную установку **самохостируемого сервера RustDesk** на Linux-машину. Вместо ручной загрузки бинарников, настройки systemd и открытия портов — один интерактивный мастер-установщик.
